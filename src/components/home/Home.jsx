            ...
            <div className="middle">
                <div className="represent-box">
                    ...
                    <div className="third-represent">
                        <div className="top-repr">
                            <div className="box1">
                                ...
                                </svg><b>  Email <br></br></b>kornelgaiz@gmail.com
                            </div>
                            <div className="box2">
                                ...
                                <b>  Date of birth <br></br></b>1996-02-29
                            </div>
                        </div> 
                        <div className="btm-repr">   
                                <div className="box3">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-geo-alt-fill" viewBox="0 0 16 16">
                                        <path d="M8 16s6-5.686 6-10A6 6 0 0 0 2 6c0 4.314 6 10 6 10zm0-7a3 3 0 1 1 0-6 3 3 0 0 1 0 6z"/>
                                    </svg>
                                    <b>Location <br></br></b> Kaunas, Lithuania
                                </div>
                                <div className="box4">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-phone-fill" viewBox="0 0 16 16">
                                        <path d="M3 2a2 2 0 0 1 2-2h6a2 2 0 0 1 2 2v12a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V2zm6 11a1 1 0 1 0-2 0 1 1 0 0 0 2 0z"/>
                                    </svg>
                                    <b>Phone Number <br></br></b><a href="tel:+37065834270">+37065834270</a>
                                </div>
                            </div>    
                    </div>
                    <div className="fourth-represent">
                        ...
                        <a href="https://github.com/Kornelyzas" target="_blank">
